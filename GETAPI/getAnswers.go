...
func GetAnswers(c *gin.Context) {
	...
	//query
	query := "select text,id,username from laboratory.answers where id = ?"
	...
	*/
	for rows.Next() {
		var panswers reusable_structs.Answers
		err := rows.Scan(&panswers.Answer, &panswers.Que_id, &panswers.Username)
		if err != nil {
